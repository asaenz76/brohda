...
function fakeSettings(overrides: Partial<BrohdaSettings> = {}): BrohdaSettings {
  return {
    ...
    markets: { marketIngestionEnabled: true, marketIngestionMinBookmakerCount: 2, postPublicationEnabled: true, postPublicationRequiresActiveMarket: true, socialPredictionEnabled: false, feedCompletedGameRetentionHours: 24 },
...
const VALID_MARKETS = { marketIngestionEnabled: true, marketIngestionMinBookmakerCount: 2, postPublicationEnabled: true, postPublicationRequiresActiveMarket: true, socialPredictionEnabled: false, feedCompletedGameRetentionHours: 24 };
