...
const PROTECTED_RPCS: Array<{
  ...
  { name: "accept_call_bs", args: { p_challenge_id: "00000000-0000-0000-0000-000000000000", p_recipient_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  { name: "accept_monetary_proposal", args: { p_proposal_id: "00000000-0000-0000-0000-000000000000", p_recipient_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "add_post_comment", args: { p_post_id: "00000000-0000-0000-0000-000000000000", p_user_id: "00000000-0000-0000-0000-000000000000", p_body: "test", p_parent_comment_id: null }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "call_bs", args: { p_challenger_user_id: "00000000-0000-0000-0000-000000000000", p_recipient_prediction_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "confirm_pool_grading_only", args: { p_pool_id: "00000000-0000-0000-0000-000000000000", p_admin_id: "00000000-0000-0000-0000-000000000000", p_grading_version: 1, p_idempotency_key: "test", p_winning_option_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "decline_call_bs", args: { p_challenge_id: "00000000-0000-0000-0000-000000000000", p_recipient_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  { name: "decline_monetary_proposal", args: { p_proposal_id: "00000000-0000-0000-0000-000000000000", p_recipient_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  { name: "delete_old_provider_request_log_rows", args: { p_retention_days: 30, p_batch_size: 1 }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "get_call_bs_record", args: { p_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: true },
  ...
  { name: "get_prediction_leaderboard", args: { p_period: "ALL_TIME", p_limit: 1, p_offset: 0 }, allowAnon: false, allowAuthenticated: true },
  ...
  { name: "get_user_prediction_record", args: { p_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: true },
  ...
  { name: "propose_money", args: { p_proposer_user_id: "00000000-0000-0000-0000-000000000000", p_recipient_prediction_id: "00000000-0000-0000-0000-000000000000", p_stake: 1, p_idempotency_key: "test", p_source_challenge_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "release_cron_lock", args: { p_job_name: "test" }, allowAnon: false, allowAuthenticated: false },
  { name: "release_reservation", args: { p_reservation_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  { name: "consume_reservation", args: { p_reservation_id: "00000000-0000-0000-0000-000000000000", p_wallet_txn_type: "manual_withdrawal", p_wallet_txn_admin_id: "00000000-0000-0000-0000-000000000000", p_wallet_txn_reason: "test", p_wallet_txn_idempotency_key: "test", p_wallet_txn_destination: "test" }, allowAnon: false, allowAuthenticated: false },
  { name: "remove_post_comment", args: { p_comment_id: "00000000-0000-0000-0000-000000000000", p_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  { name: "reserve_funds", args: { p_user_id: "00000000-0000-0000-0000-000000000000", p_amount: 1, p_purpose: "withdrawal_request", p_idempotency_key: "test" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "seed_legacy_pool_for_tests", args: { p_fixture_id: "00000000-0000-0000-0000-000000000000", p_created_by: "00000000-0000-0000-0000-000000000000", p_pool_type: "TEMPLATE_GRADED", p_question: "test", p_entry_fee: 100, p_house_fee_bps: 0, p_min_total_entries: 1, p_locks_at: "2026-01-01T00:00:00Z" }, allowAnon: false, allowAuthenticated: false },
  { name: "set_pick", args: { p_user_id: "00000000-0000-0000-0000-000000000000", p_market_id: "00000000-0000-0000-0000-000000000000", p_selected_outcome: "YES", p_yes_probability: 0.5, p_no_probability: 0.5, p_market_question: "test", p_market_close_at: null, p_market_status: "ACTIVE", p_idempotency_key: "test" }, allowAnon: false, allowAuthenticated: false },
  { name: "settle_monetary_position", args: { p_position_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "try_acquire_cron_lock", args: { p_job_name: "test", p_ttl_seconds: 1 }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "update_call_bs_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_call_bs_enabled: true, p_call_bs_rate_limit_window_seconds: 60, p_call_bs_rate_limit_max_attempts: 10 }, allowAnon: false, allowAuthenticated: false },
  { name: "update_community_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_community_distribution_enabled: true, p_community_team_distribution_enabled: true, p_community_league_distribution_enabled: true, p_community_sport_distribution_enabled: true }, allowAnon: false, allowAuthenticated: false },
  { name: "update_conversation_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_post_comment_max_length: 500, p_post_comment_rate_limit_window_seconds: 60, p_post_comment_rate_limit_max_attempts: 10 }, allowAnon: false, allowAuthenticated: false },
  { name: "update_market_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_market_ingestion_enabled: true, p_market_ingestion_min_bookmaker_count: 2, p_post_publication_enabled: true, p_post_publication_requires_active_market: true, p_social_prediction_enabled: false, p_feed_completed_game_retention_hours: 24 }, allowAnon: false, allowAuthenticated: false },
  { name: "update_monetary_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_monetary_p2p_enabled: true, p_monetary_proposal_rate_limit_window_seconds: 60, p_monetary_proposal_rate_limit_max_attempts: 10, p_p2p_fee_bps: 0 }, allowAnon: false, allowAuthenticated: false },
  { name: "update_notification_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_prediction_notifications_enabled: true, p_prediction_notify_on_correct: true, p_prediction_notify_on_incorrect: true, p_prediction_notify_on_void: true, p_prediction_notify_title_correct: "t", p_prediction_notify_body_correct: "b", p_prediction_notify_title_incorrect: "t", p_prediction_notify_body_incorrect: "b", p_prediction_notify_title_void: "t", p_prediction_notify_body_void: "b" }, allowAnon: false, allowAuthenticated: false },
  { name: "update_operations_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_settlement_batch_size: 500, p_grading_batch_size: 200, p_challenge_resolution_batch_size: 200, p_job_staleness_multiplier: 3 }, allowAnon: false, allowAuthenticated: false },
  { name: "update_prediction_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_pick_lock_minutes_before_kickoff: 10, p_prediction_cutoff_minutes_before_close: 0, p_prediction_allow_repeat: true, p_prediction_allow_stale_price: true, p_prediction_allow_unavailable_price: true, p_prediction_allow_closed_market: true }, allowAnon: false, allowAuthenticated: false },
  { name: "update_reputation_settings", args: { p_admin_id: "00000000-0000-0000-0000-000000000000", p_expected_updated_at: "2026-01-01T00:00:00Z", p_leaderboard_min_decided_picks: 5 }, allowAnon: false, allowAuthenticated: false },
  ...
  { name: "void_pool_no_refund", args: { p_pool_id: "00000000-0000-0000-0000-000000000000", p_void_reason: "ADMIN_MANUAL_CANCEL", p_idempotency_key: "test", p_admin_id: "00000000-0000-0000-0000-000000000000", p_grading_version: 1 }, allowAnon: false, allowAuthenticated: false },
  { name: "withdraw_monetary_proposal", args: { p_proposal_id: "00000000-0000-0000-0000-000000000000", p_proposer_user_id: "00000000-0000-0000-0000-000000000000" }, allowAnon: false, allowAuthenticated: false },
