...
export function ComboSettlementReviewForm({
  ...
  if (didNotPlay) {
    message =
      "A featured condition was marked “did not play.” Confirming will void this pool and refund every entry in full — no platform fee taken, no matter how the other conditions graded.";
