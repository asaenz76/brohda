...
export default async function NewPoolPage({
  ...
  const { data: fixtures } = await supabase
    ...
    .select(
      "id, external_fixture_id, home_team_external_id, home_team_name, home_team_logo_url, away_team_external_id, away_team_name, away_team_logo_url, competition_name, competition_country, competition_type, sport, provider, scheduled_start_utc",
    )
